...
//
//     def IDENTITY[N: Number](size: Int)(implicit ev: linalg.SetVecLike[SetOfVectors[N], N]):SetOfVectors[N] =
//          ev.identity(size)
//
//     def IDENTITY[N: Number](vset: SetOfVectors[N])(implicit ev: linalg.SetVecLike[SetOfVectors[N], N]): SetOfVectors[N] =
